...
public class InventoryProvider extends ContentProvider {
 ...
 //Datatbase DB Helper
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        if (suppliername == null || !InventoryEntry.isValidGender(suppliername)) {
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        //updates the database and gets the number of rows affected
        int rowsUpdated = database.update(InventoryEntry.TABLE_NAME, values, selection, selectionArgs);

        //updates for one or more rows
        if (rowsUpdated !=0) {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs){
            ...
            //if one or more rows deleted
            if (rowsDeleted != 0) {
                getContext().getContentResolver().notifyChange(uri, null);
            }
                return rowsDeleted;
            }
            //return the MIME type of dat
            @Override
